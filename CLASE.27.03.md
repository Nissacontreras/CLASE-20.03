...
Existen entre 700 y 900 leng de prog que se utilizan actualmente en la industria.  
...
* Defines el tamaño del lienzo, cargas imagenes o 

___

## createCanvas  

* Sintaxis: createCanvas ([width], [height], [render], 
...
* Establece el color que se utiliza para dibujar puntos.
